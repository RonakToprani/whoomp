import { crc32Whoop as crc32, crc8 } from './crc32';
...
export class WhoopPacket {
  ...
  constructor(type: number, seq: number, cmd: number, data: Uint8Array | number[] = new Uint8Array()) {
    this.type = type;
    this.seq = seq;
    this.cmd = cmd;
  ...
  static fromData(raw: Uint8Array | ArrayLike<number>): WhoopPacket {
